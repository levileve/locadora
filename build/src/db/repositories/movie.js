...
var MovieEntity = exports.MovieEntity = _database2.default.models.Movie;var

MovieRepository = function () {function MovieRepository() {(0, _classCallCheck3.default)(this, MovieRepository);}(0, _createClass3.default)(MovieRepository, null, [{ key: 'create', value: function () {var _ref = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee(
      movie, options) {var response;return _regenerator2.default.wrap(function _callee$(_context) {while (1) {switch (_context.prev = _context.next) {case 0:
                response = null;_context.prev = 1;


                response = MovieEntity.build(movie);_context.next = 5;return (
                ...
                response);case 12:case 'end':return _context.stop();}}}, _callee, this, [[1, 8]]);}));function create(_x, _x2) {return _ref.apply(this, arguments);}return create;}() }, { key: 'selectOne', value: function () {var _ref2 = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee2(
      ...
      options) {var response;return _regenerator2.default.wrap(function _callee2$(_context2) {while (1) {switch (_context2.prev = _context2.next) {case 0:
                response = null;_context2.prev = 1;_context2.next = 4;return (
                  ...
                  MovieEntity.findOne(options));case 4:response = _context2.sent;_context2.next = 10;break;case 7:_context2.prev = 7;_context2.t0 = _context2['catch'](1);throw (

                  new Error('persistence', _context2.t0));case 10:return _context2.abrupt('return',


                response);case 11:case 'end':return _context2.stop();}}}, _callee2, this, [[1, 7]]);}));function selectOne(_x3) {return _ref2.apply(this, arguments);}return selectOne;}() }, { key: 'selectWithPagination', value: function () {var _ref3 = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee3(
      ...
      options) {var response;return _regenerator2.default.wrap(function _callee3$(_context3) {while (1) {switch (_context3.prev = _context3.next) {case 0:
                ...
                options, {
                  distinct: options.include && options.include.length });_context3.next = 5;return (

                  MovieEntity.findAndCountAll(options));case 5:response = _context3.sent;_context3.next = 11;break;case 8:_context3.prev = 8;_context3.t0 = _context3['catch'](1);throw (

                  new Error('persistence', _context3.t0));case 11:return _context3.abrupt('return',


                response);case 12:case 'end':return _context3.stop();}}}, _callee3, this, [[1, 8]]);}));function selectWithPagination(_x4) {return _ref3.apply(this, arguments);}return selectWithPagination;}() }, { key: 'selectAll', value: function () {var _ref4 = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee4(
      ...
      options) {var response;return _regenerator2.default.wrap(function _callee4$(_context4) {while (1) {switch (_context4.prev = _context4.next) {case 0:
                ...
                options = (0, _extends3.default)({},
                options, {
                  distinct: options.include && options.include.length });_context4.next = 5;return (

                  MovieEntity.findAll(options));case 5:response = _context4.sent;_context4.next = 11;break;case 8:_context4.prev = 8;_context4.t0 = _context4['catch'](1);throw (

                  new Error('persistence', _context4.t0));case 11:return _context4.abrupt('return',


                response);case 12:case 'end':return _context4.stop();}}}, _callee4, this, [[1, 8]]);}));function selectAll(_x5) {return _ref4.apply(this, arguments);}return selectAll;}() }, { key: 'updateById', value: function () {var _ref5 = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee5(


      id, movie, options) {var response, _response, _response2, _response2$;return _regenerator2.default.wrap(function _callee5$(_context5) {while (1) {switch (_context5.prev = _context5.next) {case 0:
                response = null;_context5.prev = 1;_context5.next = 4;return (


                  MovieEntity.update(movie, {
                    where: { id: id },
      ...
      id, updateBy, options) {var response, _response3, _response4, _response4$;return _regenerator2.default.wrap(function _callee6$(_context6) {while (1) {switch (_context6.prev = _context6.next) {case 0:
                ...
                response);case 15:case 'end':return _context6.stop();}}}, _callee6, this, [[1, 11]]);}));function deleteById(_x9, _x10, _x11) {return _ref6.apply(this, arguments);}return deleteById;}() }]);return MovieRepository;}();exports.default = MovieRepository;