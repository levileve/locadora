...
var _movie = require('../../services/movie');var _movie2 = _interopRequireDefault(_movie);
var _middlewares = require('../middlewares');


var _movie3 = require('../schemas/movie');
...
var _movie4 = require('./filters/movie');function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}

var routes = _express2.default.Router();

routes.post('/',
_middlewares.auth,
(0, _middlewares.checkSchema)(_movie3.movieCreate),
(0, _middlewares.authorize)([_profileType2.default.ADMIN]), function () {var _ref = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(
  function _callee(req, res) {var response;return _regenerator2.default.wrap(function _callee$(_context) {while (1) {switch (_context.prev = _context.next) {case 0:
            response = void 0;_context.prev = 1;_context.next = 4;return (
              ...
              _movie2.default.create(req.body, req.user));case 4:response = _context.sent;_context.next = 10;break;case 7:_context.prev = 7;_context.t0 = _context['catch'](1);return _context.abrupt('return',
...
(0, _expressValidator.param)('id').isUUID().withMessage(_business.ValidationCodeError.INVALID_ID), function () {var _ref2 = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(
  function _callee2(req, res) {var response;return _regenerator2.default.wrap(function _callee2$(_context2) {while (1) {switch (_context2.prev = _context2.next) {case 0:
            ...
            (0, _expressValidator.validationResult)(req).throw();_context2.next = 5;return (
              _movie2.default.getById(req.params.id, req.user));case 5:response = _context2.sent;_context2.next = 11;break;case 8:_context2.prev = 8;_context2.t0 = _context2['catch'](1);return _context2.abrupt('return',
...
_middlewares.auth, function () {var _ref3 = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(
  function _callee3(req, res) {var response, searchParameter;return _regenerator2.default.wrap(function _callee3$(_context3) {while (1) {switch (_context3.prev = _context3.next) {case 0:
            ...
            (0, _movie4.getAllFilter)(req));_context3.next = 5;return (


              _movie2.default.getAllWithPagination(searchParameter));case 5:response = _context3.sent;_context3.next = 11;break;case 8:_context3.prev = 8;_context3.t0 = _context3['catch'](1);return _context3.abrupt('return',
...
(0, _middlewares.checkSchema)(_movie3.movieUpdate), function () {var _ref4 = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(
  function _callee4(req, res) {var response;return _regenerator2.default.wrap(function _callee4$(_context4) {while (1) {switch (_context4.prev = _context4.next) {case 0:
            response = void 0;_context4.prev = 1;_context4.next = 4;return (
              ...
              _movie2.default.updateById(req.params.id, req.body, req.user));case 4:response = _context4.sent;_context4.next = 10;break;case 7:_context4.prev = 7;_context4.t0 = _context4['catch'](1);return _context4.abrupt('return',
...
(0, _middlewares.authorize)([_profileType2.default.ADMIN]), function () {var _ref5 = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(
  function _callee5(req, res) {var response;return _regenerator2.default.wrap(function _callee5$(_context5) {while (1) {switch (_context5.prev = _context5.next) {case 0:
            response = void 0;_context5.prev = 1;


            (0, _expressValidator.validationResult)(req).throw();_context5.next = 5;return (
              _movie2.default.deleteById(req.params.id, req.user));case 5:response = _context5.sent;_context5.next = 11;break;case 8:_context5.prev = 8;_context5.t0 = _context5['catch'](1);return _context5.abrupt('return',

            (0, _middlewares.errorHandler)(_context5.t0, req, res));case 11:return _context5.abrupt('return',


            res.status(_httpStatus2.default.OK).json(response));case 12:case 'end':return _context5.stop();}}}, _callee5, undefined, [[1, 8]]);}));return function (_x9, _x10) {return _ref5.apply(this, arguments);};}());exports.default =
